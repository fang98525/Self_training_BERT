...
class Config(object):
    def __init__(self):
        ...
        self.pretrain_model_path = '/data1/home/fzq/projects/nlpclassification/data/model/nezha-cn-base/nezha-cn-base/'  #使用nezha或者Roberta 的预训练模型
        self.bert_config_json = self.pretrain_model_path + "config.json"  # 为''时从零训练
        ...
        self.train_batch_size = 12  # 根据GPU卡而定
